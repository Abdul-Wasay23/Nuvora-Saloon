...
@php
// Agar limit valid positive number hai to apply karo, nahi to sab barbers fetch karo
$barbers = \App\Models\Barber::orderBy('id','desc')
    ->when(is_numeric($limit) && $limit > 0, function($query) use ($limit) {
